...
process.env.NODE_ENV !== "production" ? Dialog.propTypes = {
  ...
  PaperProps: (0, _chainPropTypes.default)(_propTypes.default.object, function (props) {
    ...
    if ('className' in PaperProps) {
      return new Error('Material-UI: `className` overrides all `Dialog` specific styles in `Paper`. ' + 'If you wanted to add ' + 'styles to the `Paper` component use `classes.paper` in the `Dialog` props ' + "instead.".concat(process.env.NODE_ENV === 'test' ? Date.now() : ''));
    }
